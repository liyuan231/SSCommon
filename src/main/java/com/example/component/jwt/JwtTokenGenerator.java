...
public class JwtTokenGenerator {
    ...
    public JwtTokenGenerator(JwtPayloadBuilder jwtPayloadBuilder,JwtProperties jwtProperties) throws CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, InvalidKeySpecException, IOException {
